...
function ucc_mcm_admin_menu() {
	add_submenu_page( 'index.php', 'Multisite Comments', 'Multisite Comments', 'moderate_comments', 'multisite-comments', 'ucc_mcm_admin_view' );
}
add_action( 'admin_menu', 'ucc_mcm_admin_menu' );
